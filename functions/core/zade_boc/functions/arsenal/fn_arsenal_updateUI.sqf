...
(_display displayCtrl 9233) ctrlSetText format ["functions\zade_boc\data\actions\%1_ca.paa",_action];
(_display displayCtrl 9233) ctrlSetTooltip "Toggle backpack on back/chest";
