// ******************************************************************************************
// * This file is licensed under the GNU Affero GPL v3. Copyright © 2014 A3Wasteland.com *
// ******************************************************************************************
...
switch (true) do
{
	...
	default
	{
		...
		{
			case ([_unit, _class, "uniform"] call TFD_fnc_fitsInventory):  { uniformContainer _unit };
			case ([_unit, _class, "vest"] call TFD_fnc_fitsInventory):     { vestContainer _unit };
